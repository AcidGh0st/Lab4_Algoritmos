...
public class DoublyLinkedList implements List{
    ...
    public void addLast(Object element) {
        ...
        if (isEmpty()) {
            ...
            aux.next = newNode;
            newNode.prev = aux; // Actualizamos el enlace prev del nuevo nodo
        }
    }
    ...
    public void addInSortedList(Object element) {
        Node newNode = new Node(element);
        if (isEmpty() || (first != null && Utility.compare(first.data, element) > 0)) {
            // Si la lista está vacía o el elemento es menor que el primer nodo,
            // el nuevo nodo se convierte en el primer nodo
            newNode.next = first;
            if (first != null) {
                first.prev = newNode; // Actualizar el enlace prev del primer nodo
            }
            first = newNode;
        } else {
            Node aux = first;
            ...
            while (aux.next != null && Utility.compare(aux.next.data, element) < 0) {
                aux = aux.next;
            }

            // Insertamos el nuevo nodo después de current
            newNode.next = aux.next;
            if (aux.next != null) {
                aux.next.prev = newNode; // Actualizar el enlace prev del nodo siguiente
            }
            aux.next = newNode;
            newNode.prev = aux; // Establecer el enlace prev del nuevo nodo
        }
    }
    ...
    public Object removeFirst() throws ListException {
        ...
        first = first.next; // Mover el primer nodo al siguiente
        if (first != null) {
            first.prev = null; // Romper el enlace prev del nuevo primer nodo
        }
        return data;
    }
    ...
    public Object removeLast() throws ListException {
        ...
        Node aux = first;
        // Mientras no llegue al último nodo
        while(aux.next != null){
            aux = aux.next;
        }
        Object data = aux.data;
        if(aux.prev != null){
            aux.prev.next = null; // Romper el enlace next del penúltimo nodo
        } else {
            first = null; // Si solo hay un nodo en la lista
        }
        return data;
    }
    ...
    public Object getNext(Object element) throws ListException {
        ...
        while(aux != null){
            if(util.Utility.compare(aux.data, element) == 0){
                return aux.next != null ? aux.next.data : "Does not exist in Doubly Linked List"; // Si existe un nodo siguiente, devolver su data
            }
            aux = aux.next;
        }
